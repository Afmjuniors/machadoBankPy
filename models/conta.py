...
class Conta:
    ...
    def __init__(self: object, cliente: Cliente) -> None:
        self.__numero_conta = Conta.codigo
    ...
    def __str__(self: object) -> str:
        return f'Numero da conta: {self.numero} \nCliente: {self.cliente.nome} \nSaldo Total:' \
               f'{formata_float_str_moeda(self.saldo_total)}'
    ...
    @saldo_total.setter
    def saldo_total(self: object, valor: float) -> float:
    ...
    def depositar(self: object, valor: float) -> None:
        if valor > 0:
            ...
            print('Erro ao efetuar o deposito tente novamente')
    ...
    def sacar(self: object, valor: float) -> None:
        if 0 < valor <= self.saldo_total:
            ...
            print('Erro ao efetuar do saque tente novamente')
    ...
    def transferir(self: object, destino: object, valor: float) -> None:
        if 0 < valor <= self.saldo_total:
            ...
            print('Erro ao efetuar a transferencia tente novamente')
